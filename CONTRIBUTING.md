# Contributing to Klingon

We would love for you to contribute to Klingon and help make it even better
...
Klingon follows the same Code of Condut as Angular. You can read it [here][https://github.com/angular/code-of-conduct/blob/master/CODE_OF_CONDUCT.md].

## <a name="question"></a> Got a Question or Problem?

Do not open issues for general support questions as we want to keep GitHub issues for bug reports and feature requests. You've got much better chances of getting your question answered on [Stack Overflow](https://stackoverflow.com/questions/tagged/angular-klingon) where the questions should be tagged with tag `angular-klingon`.
...
- OS / Browser
- version of @klingon/ui
- version of @klingon/app
- version of @klingon/server
...
You can file new issues by filling out our [new issue form](https://github.com/manekinekko/klingon/issues/new).


### <a name="submit-pr"></a> Submitting a Pull Request (PR)
Before you submit your Pull Request (PR) consider the following guidelines:

* Search [GitHub](https://github.com/manekinekko/klingon/pulls) for an open or closed PR
...
* In GitHub, send a pull request to `klingon:master`.
...
we use the git commit messages to **generate the Klingon change log**.
...
[GitHub]: https://github.com/manekinekko/klingon
